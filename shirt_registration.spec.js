...
describe('shop e2e', () => {
    ...
    it('Opens shop and orders an item', () => {
        ...
        cy.get(':nth-child(2) > .mt10 > a')
        .should('be.visible')
        .click()

        cy.get(':nth-child(3) > .thumbnail > .pricetag > .productcart > .fa')
        .click()

        cy.get('#option350')
        .select('775')
        .should('have.value', '775')
        ...
        .type('stefanveleusic@hotmail.com')
        .should('have.value', 'stefanveleusic@hotmail.com')
